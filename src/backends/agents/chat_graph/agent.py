...
class ChatAgent(BaseAgent):
    ...
    def __init__(self, user_config: UserConfig, llm: "LLM", checkpointer: Optional[AsyncSqliteSaver] = None):
    ...
    @classmethod
    async def create(cls, user_config: UserConfig, checkpointer: Optional[AsyncSqliteSaver] = None) -> "ChatAgent":
...
async def create_chat_agent_with_langgraph(config: Optional[UserConfig] = None) -> ChatAgent:
    """
