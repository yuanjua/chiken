      ...
      try {
        ...
        if (config) {
          ...
          setSelectedModel(prev => ({
            ...
            apiKey: config.api_key ?? prev.apiKey,
            ...
            searchEngine: config.search_engine ?? prev.searchEngine,
            searchEndpoint: config.search_endpoint ?? prev.searchEndpoint,
            searchApiKey: config.search_api_key ?? prev.searchApiKey,
          }));
        }
