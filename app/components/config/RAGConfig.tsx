...
export function RAGConfig(props: RAGConfigProps) {
  ...
  React.useEffect(() => {
    if (refreshTrigger !== undefined) {
      console.log(`RefreshTrigger changed, refreshing embedding models for ${provider}...`);
        ...
        <div className="lg:col-span-2 space-y-3">
          ...
          <div className="relative">
            ...
            <ModelSuggestDropdown
              ...
              disabled={provider === "ollama" && !selectedModel.baseUrl}
              placeholder={
                provider === "ollama" && !selectedModel.baseUrl
                  ? "Configure base URL first"
                  : `Type to search ${provider} models`
              }
