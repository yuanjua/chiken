...
def normalize_model_name(model_name: Optional[str], provider: Optional[str] = None, model_type: str = "chat") -> Optional[str]:
    """
...
def normalize_chat_model_name(model_name: Optional[str], provider: Optional[str] = None) -> Optional[str]:
    """Normalize chat model name to LiteLLM format."""
    return normalize_model_name(model_name, provider, "chat")


def normalize_embedding_model_name(model_name: Optional[str], provider: Optional[str] = None) -> Optional[str]:
