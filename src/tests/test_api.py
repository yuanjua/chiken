...
class TestRAGAPIEndpoints:
    ...
    def test_search_documents(self, client, mock_rag_service):
        ...
        payload = {"query": "test query", "knowledge_base_names": ["test_kb"], "k": 5}
    ...
    def test_search_documents_empty_knowledge_bases(self, client, mock_rag_service):
        ...
        mock_rag_service.query_documents.side_effect = HTTPException(
            status_code=400, detail="No knowledge bases available for querying"
        )
...
class TestSessionAPIEndpoints:
    ...
    def test_get_session_history(self, client, mock_session_service):
        ...
        mock_history = [
            {"id": "msg1", "role": "user", "content": "Hello", "timestamp": "2025-07-28T04:00:00Z"},
            {
                "id": "msg2",
                "role": "assistant",
                "content": "Hi there!",
    ...
    def test_list_sessions(self, client, mock_session_service):
        ...
        mock_sessions = [
            {"session_id": "session1", "agent_type": "chat", "created_at": "2025-07-28T03:00:00Z"},
            {"session_id": "session2", "agent_type": "chat", "created_at": "2025-07-28T04:00:00Z"},
        ]
...
class TestStreamingEndpoints:
    ...
    def test_stream_with_invalid_session(self, client, mock_session_service):
        ...
        mock_session_service.stream_response.side_effect = HTTPException(status_code=404, detail="Session not found")
...
class TestConcurrencyAndPerformance:
    ...
    async def test_concurrent_embedding_requests(self):
        ...
        with patch("aiohttp.ClientSession.post") as mock_post:
            ...
            tasks = [embedding_function._get_single_embedding(f"text {i}") for i in range(10)]
