...
export function PdfParserConfig({
  ...
  const isRemoteParser = selectedModel.pdfParserType === "remote";
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div className="lg:col-span-2 space-y-2">
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="remote">Remote Parser</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          {isRemoteParser && (
            <div>
              <Label htmlFor="pdfParserUrl">Remote Parser URL</Label>
              <Input
                id="pdfParserUrl"
        ...
        <div className="lg:col-span-2">
          <div className="text-sm p-3 bg-muted rounded-lg h-full flex flex-col justify-center">
            {isRemoteParser ? (
              <div>
                <strong className="text-foreground">Remote Parser</strong>
